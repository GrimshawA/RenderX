...
void RxFramebuffer::activate()
{
	gGraphicsDevice->setFramebuffer(this);
}

void RxFramebuffer::setRenderbuffer()
{
...
void RxFramebuffer::setDepthBuffer(int width, int height)
{
