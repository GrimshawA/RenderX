#ifndef NephilimGDI_GraphicsDevice_h__
#define NephilimGDI_GraphicsDevice_h__
...
*/
class DAEVA_API RenderCore : public DvObject
{
protected:
...
/// Global accessor to the graphics device
extern RenderCore* gGraphicsDevice;

#endif // NephilimGDI_GraphicsDevice_h__
